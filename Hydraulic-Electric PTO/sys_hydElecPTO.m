...
volLoss_m = par.motor.C_s*(delta_p_m/(par.mu*abs(control.w_m))) ...
                   + (delta_p_m/par.beta)*(par.motor.V_r + 1);
...
nonState.q_m = (nonState.pmPumping*nonState.eta_v_m ...
                ...
                *par.motor.D*control.w_m;

mechLoss_m = par.motor.C_v*par.mu*abs(control.w_m)/delta_p_m + par.motor.C_f;
